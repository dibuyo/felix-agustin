...
function HomePage() {
  ...
  />
    <div className="object-none object-center mt-40 items-center lg:mt-auto">
      <img src="/img/imagen.png" className="w-50 ml-auto mr-auto"></img>
    </div>
    <div className="fixed top-3 items-center">
      <div>
        <a className="flex items-center justify-between p-4 mb-8 ml-2 mr-3 text-sm font-semibold text-purple-100 bg-blue-600 rounded-lg shadow-md hover:bg-indigo-700 md:py-4 md:text-lg" href="https://goo.gl/maps/2UvdWeWQYF4pJj6y7" target="_blank" >
          <div className="flex items-center">
            <svg className="w-5 h-5 mr-2" fill="currentColor" viewBox="0 0 20 20">
              <path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z"></path>
            </svg>
            <span>Los esperamos el sábado 23 de Octubre en Barrio Don Joaquín, Ruta 58, KM 9, Canning. ¿Cómo llegar?</span>
          </div>
        </a>
      </div>
    </div>
    ...
    <div className="flex flex-wrap items-center md:justify-between justify-center">
      <div className="w-full md:w-4/12 px-4 mx-auto text-center">
        <div className="text-sm text-blueGray-500 font-semibold py-1">
          Copyright © <span id="get-current-year">2021</span><span className="text-blueGray-500 hover:text-gray-800" target="_blank"> Felix Agustin</span>
        </div>
      </div>
    </div>
      </div>
